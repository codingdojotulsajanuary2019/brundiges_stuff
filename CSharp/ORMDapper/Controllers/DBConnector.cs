...
namespace ORMDapper.Controllers //you can leave as is, or change to your own namespace
{
	public class DbConnector
	{
		static string server = "localhost";
		static string db = "csharpstuff"; //Change to your schema name
		static string port = "3306";
		static string user = "root";
		static string pass = "Cheeseburger52";
